    ...
    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
      ...
      <form>
        ...
        <div className="mb-4">
          ...
          <input id="quantity" type="number" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-6">
          <p className="text-gray-700 text-sm">
            Tổng số tiền của bạn là: <span className="font-bold">10.000VND</span>
          </p>
        </div>
